...
<review>
  ...
  <overallSuggestions>
    ...
    def post_placeholder_comment(self, owner, repo, pull_number):
        ...
        comment = pr.create_issue_comment("PR Review Bot is analyzing your changes... Please wait.")
        return comment.id
...
{chr(10).join([f"## {file['path']}\n{file['analysis']}" for file in analysis['file_analyses']])}

## Suggestions for Improvement
{chr(10).join([f"• {suggestion}" for suggestion in analysis['overall_suggestions']])}
...
*Generated by PR Review Bot*"""
        ...
        comment.edit(final_review_body)
